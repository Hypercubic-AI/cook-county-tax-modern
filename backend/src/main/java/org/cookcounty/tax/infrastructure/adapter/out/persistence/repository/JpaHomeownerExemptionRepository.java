...
/// Persists the annual exemption generation without applying homeowner eligibility rules.
public interface JpaHomeownerExemptionRepository
        extends JpaRepository<HomeownerExemptionEntity, Long> {
