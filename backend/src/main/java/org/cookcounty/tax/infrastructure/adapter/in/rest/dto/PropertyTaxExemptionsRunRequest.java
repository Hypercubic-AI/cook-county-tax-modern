...
public class PropertyTaxExemptionsRunRequest {
    ...
    public PropertyTaxExemptionsRunRequest() {}
    ...
    @AssertTrue(message = "homeownerProcessingVariant is required.")
    @JsonIgnore
    public boolean isHomeownerProcessingVariantPresent() {
        return homeownerProcessingVariant != null;
    }

    @AssertTrue(message = "homeownerProcessingVariant must be ENUMERATED or BROAD.")
    @JsonIgnore
    public boolean isHomeownerProcessingVariantSupported() {
        return homeownerProcessingVariant == null
                || "ENUMERATED".equals(homeownerProcessingVariant)
                || "BROAD".equals(homeownerProcessingVariant);
    }
}
