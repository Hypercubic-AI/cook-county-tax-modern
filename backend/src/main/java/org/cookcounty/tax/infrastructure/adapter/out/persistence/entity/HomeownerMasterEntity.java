...
public class HomeownerMasterEntity {
    ...
    @Column(name = "temporary_assessed_value")
    private Long temporaryAssessedValue;
    ...
    public Long getTemporaryAssessedValue() { return temporaryAssessedValue; }
    public void setTemporaryAssessedValue(Long temporaryAssessedValue) { this.temporaryAssessedValue = temporaryAssessedValue; }
